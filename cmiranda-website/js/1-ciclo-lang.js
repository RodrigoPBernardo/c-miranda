const translationsEn = {
    ...
    tituloPrimeiroCiclo: "PRIMARY EDUCATION",
    primeiroCiclo1: "Example 1",
    primeiroCiclo2: "Example 2",
    primeiroCiclo3: "Example 3",
    primeiroCiclo4: "Example 4",
    voltar: "Back",
    siga: "Follow Us",
...
const translationsFr = {
    ...
    contactosMobile: "Contacts",
    tituloPrimeiroCiclo: "ENSEIGNEMENT PRIMAIRE",
    primeiroCiclo1: "Exemple 1",
    primeiroCiclo2: "Exemple 2",
    primeiroCiclo3: "Exemple 3",
    primeiroCiclo4: "Exemple 4",
    voltar: "Retour",
    siga: "Suivez-nous",
...
const translationsEs = {
    ...
    tituloPrimeiroCiclo: "PRIMERE CICLO",
    primeiroCiclo1: "Ejemplo 1",
    primeiroCiclo2: "Ejemplo 2",
    primeiroCiclo3: "Ejemplo 3",
    primeiroCiclo4: "Ejemplo 4",
    voltar: "Volver",
    siga: "Síganos",
...
const translationsPt = {
    ...
    contactosMobile: "Contactos",
    tituloPrimeiroCiclo: "1º Ciclo",
    primeiroCiclo1: "Exemplo 1",
    primeiroCiclo2: "Exemplo 2",
    primeiroCiclo3: "Exemplo 3",
    primeiroCiclo4: "Exemplo 4",
    voltar: "Voltar",
    siga: "Siga-nos",
