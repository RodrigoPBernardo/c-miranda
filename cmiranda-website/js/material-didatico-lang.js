const translationsEn = {
    ...
    tituloMaterialDidatico: "Teaching Material",
    materialDidatico1: "Example 1",
    materialDidatico2: "Example 2",
    materialDidatico3: "Example 3",
    materialDidatico4: "Example 4",
    voltar: "Back",    
    siga: "Follow Us",
...
const translationsFr = {
    ...
    contactosMobile: "Contacts",
    tituloMaterialDidatico: "Matériel Didactique",
    materialDidatico1: "Exemple 1",
    materialDidatico2: "Exemple 2",
    materialDidatico3: "Exemple 3",
    materialDidatico4: "Exemple 4",
    voltar: "Retour",
    siga: "Suivez-nous",
...
const translationsEs = {
    ...
    tituloMaterialDidatico: "Material Didáctico",
    materialDidatico1: "Ejemplo 1",
    materialDidatico2: "Ejemplo 2",
    materialDidatico3: "Ejemplo 3",
    materialDidatico4: "Ejemplo 4",
    voltar: "Volver",
    siga: "Síganos",
...
const translationsPt = {
    ...
    contactosMobile: "Contactos",
    tituloMaterialDidatico: "Material Didático",
    materialDidatico1: "Exemplo 1",
    materialDidatico2: "Exemplo 2",
    materialDidatico3: "Exemplo 3",
    materialDidatico4: "Exemplo 4",
    voltar: "Voltar",
    siga: "Siga-nos",
