const translationsEn = {
    ...
    tituloMaterialDesgaste: "Wear and Plastic Arts Material",
    materialDesgaste1: "Example 1",
    materialDesgaste2: "Example 2",
    materialDesgaste3: "Example 3",
    materialDesgaste4: "Example 4",
    voltar: "Back",
    siga: "Follow Us",
...
const translationsFr = {
    ...
    contactosMobile: "Contacts",
    tituloMaterialDesgaste: "Matériel d'Usure et Arts Plastiques",
    materialDesgaste1: "Exemple 1",
    materialDesgaste2: "Exemple 2",
    materialDesgaste3: "Exemple 3",
    materialDesgaste4: "Exemple 4",
    voltar: "Retour",
    siga: "Suivez-nous",
...
const translationsEs = {
    ...
    tituloMaterialDesgaste: "Material de Desgaste y Artes Plásticas",
    materialDesgaste1: "Ejemplo 1",
    materialDesgaste2: "Ejemplo 2",
    materialDesgaste3: "Ejemplo 3",
    materialDesgaste4: "Ejemplo 4",
    voltar: "Volver",
    siga: "Síganos",
...
const translationsPt = {
    ...
    contactosMobile: "Contactos",
    tituloMaterialDesgaste: "Material de Desgaste e Artes Plásticas",
    materialDesgaste1: "Exemplo 1",
    materialDesgaste2: "Exemplo 2",
    materialDesgaste3: "Exemplo 3",
    materialDesgaste4: "Exemplo 4",
    voltar: "Voltar",
    siga: "Siga-nos",
