const translationsEn = {
    ...
    tituloMobiliarioEscolar: "School Furniture",
    mobiliarioEscolar1: "Example 1",
    mobiliarioEscolar2: "Example 2",
    mobiliarioEscolar3: "Example 3",
    mobiliarioEscolar4: "Example 4",
    voltar: "Back",
    siga: "Follow Us",
...
const translationsFr = {
    ...
    contactosMobile: "Contacts",
    tituloMobiliarioEscolar: "Mobilier Scolaire",
    mobiliarioEscolar1: "Exemple 1",
    mobiliarioEscolar2: "Exemple 2",
    mobiliarioEscolar3: "Exemple 3",
    mobiliarioEscolar4: "Exemple 4",
    voltar: "Retour",
    siga: "Suivez-nous",
...
const translationsEs = {
    ...
    tituloMobiliarioEscolar: "Mobiliario Escolar",
    mobiliarioEscolar1: "Ejemplo 1",
    mobiliarioEscolar2: "Ejemplo 2",
    mobiliarioEscolar3: "Ejemplo 3",
    mobiliarioEscolar4: "Ejemplo 4",
    voltar: "Volver",
    siga: "Síganos",
...
const translationsPt = {
    ...
    contactosMobile: "Contactos",
    tituloMobiliarioEscolar: "Mobiliario Escolar",
    mobiliarioEscolar1: "Exemplo 1",
    mobiliarioEscolar2: "Exemplo 2",
    mobiliarioEscolar3: "Exemplo 3",
    mobiliarioEscolar4: "Exemplo 4",
    voltar: "Voltar",
    siga: "Siga-nos",
