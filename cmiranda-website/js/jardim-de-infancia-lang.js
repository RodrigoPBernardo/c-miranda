const translationsEn = {
    ...
    tituloJardimInfancia: "KINDERGARTEN",
    jardimInfancia1: "Example 1",
    jardimInfancia2: "Example 2",
    jardimInfancia3: "Example 3",
    jardimInfancia4: "Example 4",
    voltar: "Back",
    siga: "Follow Us",
...
const translationsFr = {
    ...
    contactosMobile: "Contacts",
    tituloJardimInfancia: "Mobilier Scolaire",
    jardimInfancia1: "Exemple 1",
    jardimInfancia2: "Exemple 2",
    jardimInfancia3: "Exemple 3",
    jardimInfancia4: "Exemple 4",
    voltar: "Retour",
    siga: "Suivez-nous",
    politicaPrivacidade: "JARDIN D'ENFANTS",
...
const translationsEs = {
    ...
    tituloJardimInfancia: "JARDÍN DE INFANCIA",
    jardimInfancia1: "Ejemplo 1",
    jardimInfancia2: "Ejemplo 2",
    jardimInfancia3: "Ejemplo 3",
    jardimInfancia4: "Ejemplo 4",
    voltar: "Volver",
    siga: "Síganos",
...
const translationsPt = {
    ...
    contactosMobile: "Contactos",
    tituloJardimInfancia: "Jardim de Infância",
    jardimInfancia1: "Exemplo 1",
    jardimInfancia2: "Exemplo 2",
    jardimInfancia3: "Exemplo 3",
    jardimInfancia4: "Exemplo 4",
    voltar: "Voltar",
    siga: "Siga-nos",
